...
│   └── nginx.conf
├── configs/
│   ├── docker/                    # docker-compose*.yml (dev/prod/override)
│   ├── ci-cd/                     # Codecov, Fly, Netlify, Render, Vercel
│   ├── linting/                   # ESLint and editor defaults
...
├── configs/docker/docker-compose.prod.yml
├── configs/docker/docker-compose.override.yml
├── vercel.json
├── fly.toml
├── render.yaml
└── README.md
