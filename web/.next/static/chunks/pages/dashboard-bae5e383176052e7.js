(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [26],
  {
    7504: function (e, r, n) {
      ...
      var t, o;
      e.exports =
        (null == (t = n.g.process) ? void 0 : t.env) &&
    ...
    8006: function (e, r, n) {
      ...
      function a() {
        ...
        async function u() {
          ...
          (n(r.sessionId), r.url && (window.location.href = r.url));
        }
        async function c() {
    ...
    7805: function (e, r, n) {
      ...
      var t = n(7504);
      function o() {
        let e = t.env.NEXT_PUBLIC_API_BASE || "/api";
        function r(e) {
          let r = { ...(e || {}) };
          {
            let e = window.localStorage.getItem("authToken");
            e && (r.Authorization = "Bearer ".concat(e));
          }
          return r;
        }
        return {
          get: async function (n) {
            let t = await fetch(e + n, { headers: r() });
            if (!t.ok) throw Error(await t.text());
            return t.json();
          },
          post: async function (n, t) {
    ...
    3795: function (e, r, n) {
      ...
      function a() {
        ...
        async function l() {
          if (r.trim()) {
            c(!0);
            try {
              let n = await e.post("/voice/command", { text: r });
              s(n);
            } catch (e) {
      ...
      function c() {
        ...
        return (
          (0, o.useEffect)(() => {
            let e = u.env.NEXT_PUBLIC_API_BASE || "/api";
            fetch("".concat(e, "/health"))
              .then((e) => e.json())
              .then((e) => r(e))
              .catch(() => r({ ok: !1 }))
              .finally(() => i(!1));
          ...
          (0, t.jsxs)("main", {
            ...
            children: [
              ...
              n && (0, t.jsx)("p", { children: "Loading status…" }),
              !n &&
                (0, t.jsx)("pre", {
                  style: {
                    background: "#0b0b12",
              ...
              ((o.nextTick = function (e) {
                ...
                if (arguments.length > 1)
                  for (var n = 1; n < arguments.length; n++)
                    r[n - 1] = arguments[n];
                (u.push(new p(e, r)), 1 !== u.length || c || s(f));
              }),
