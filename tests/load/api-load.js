...
export default function (data) {
    ...
    group('Track Shipment', () => {
        ...
        const res = http.get(`${API_URL}/api/shipments/track/${trackingNumber}`, { headers });

        check(res, {
            'track shipment status is 200 or 404': (r) => [200, 404].includes(r.status),
    ...
    if (data.token) {
        group('AI Decision', () => {
            ...
            check(res, {
                'AI decision status is 200 or 429': (r) => [200, 429].includes(r.status),
