...
echo "--------------------"
check "compression middleware" "grep -q 'compression' /workspaces/Infamous-freight-enterprises/api/package.json"
check "web-vitals tracking" "grep -q 'web-vitals' /workspaces/Infamous-freight-enterprises/web/package.json"
check "API performance middleware" "test -f /workspaces/Infamous-freight-enterprises/api/src/middleware/performance.js"
check "Database optimization utils" "test -f /workspaces/Infamous-freight-enterprises/api/src/utils/dbOptimization.js"
echo ""
...
check "Monitoring config module" "test -f /workspaces/Infamous-freight-enterprises/api/src/config/monitoring.js"
...
echo "-------------------------"
check "Compression in server" "grep -q 'compressionMiddleware' /workspaces/Infamous-freight-enterprises/api/src/server.js"
check "Datadog APM import" "grep -q 'dd-trace' /workspaces/Infamous-freight-enterprises/api/src/server.js"
check "Sentry configured" "grep -q 'sentry' /workspaces/Infamous-freight-enterprises/api/src/server.js"
echo ""
